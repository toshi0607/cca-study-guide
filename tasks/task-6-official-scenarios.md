...
- Lighthouse: could not run — headless Chrome returns NO_FCP in this sandbox (environment limitation, not an app fault; app renders correctly via the browser and passes axe/E2E). Browser-observed DCL 21ms / load 43ms; axe serious/critical = 0.
