  ...
  return (
    <section class="mock-exam-analysis" aria-labelledby="mock-exam-analysis-title">
      <header class="page-header compact">
        ...
        <h2 id="mock-exam-analysis-title" tabIndex={-1} ref={headingRef}>{a.title}</h2>
        <p>{a.intro}</p>
      </header>
      ...
      {isEmpty
        ...
        : <>
            <div class="mock-exam-range" role="group" aria-label={a.rangeLegend}>
              ...
              <button type="button" class="mock-exam-range-option" aria-pressed={range === 'all-time'} onClick={() => setRange('all-time')}>{a.rangeAllTime}</button>
              <button type="button" class="mock-exam-range-option" aria-pressed={range === 'recent-3'} onClick={() => setRange('recent-3')}>{a.rangeRecent3}</button>
            ...
            <p class="mock-exam-analysis-note" role="note">{a.staleNote}</p>

            <section class="mock-exam-stability" aria-labelledby="mock-exam-analysis-stability-title">
              <h3 id="mock-exam-analysis-stability-title">{a.stabilityHeading}</h3>
            ...
            <section class="mock-exam-evidence" aria-labelledby="mock-exam-analysis-evidence-title">
              <h3 id="mock-exam-analysis-evidence-title">{a.evidenceLegend}</h3>
            ...
            <section class="mock-exam-priority" aria-labelledby="mock-exam-analysis-review-title">
              <h3 id="mock-exam-analysis-review-title">{a.reviewHeading}</h3>
              <p class="mock-exam-analysis-note">{a.reviewNote}</p>
      ...
      <button type="button" class="mock-exam-link" onClick={onBack}>{a.back}</button>
    </section>
  );
}
