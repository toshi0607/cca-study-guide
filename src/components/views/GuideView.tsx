        ...
        {studyGuideSections.map((section) => {
          ...
          return <details class="guide-section" id={`guide-section-${section.id}`} key={section.id}>
            ...
            <div class="guide-section-body">
              ...
              {section.relatedCardIds.length > 1 && <p><button type="button" class="btn btn--secondary guide-related-open-all" onClick={() => onOpenCards(section.relatedCardIds, origin)}>{copy.guide.relatedCardsOpenAll(section.relatedCardIds.length)}</button></p>}
